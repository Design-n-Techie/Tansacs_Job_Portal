...
function AdminHome(props) {
    ...
    async function LogoutUser() {
        try {
            const response = await axios.post('http://52.66.175.54:8000/logout', {
                headers: {
    ...
    return ( 
        ...
        <p className=' text-2xl font-semibold '>DASHBOARD HAS TO BE ESTABLISHED TO TRACK RECEIVED JOB POSTING</p>
